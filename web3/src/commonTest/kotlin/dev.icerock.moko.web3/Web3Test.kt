...
class Web3Test {
    ...
    fun `read transaction`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_getTransactionByHash","params":["0x627914c8d005ab0dc7f44719dc658af72e534e083867a2a316d4b25555515352"]}]""",
                actual = body.text
            )
    ...
    fun `read transaction receipt`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertTrue(body is TextContent)
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_getTransactionReceipt","params":["0x627914c8d005ab0dc7f44719dc658af72e534e083867a2a316d4b25555515352"]}]""",
                actual = body.text
            )
    ...
    fun `read balance`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertTrue(body is TextContent)
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_getBalance","params":["0xdE7eC4E4895D7d148906a0DFaAF7f21ac5C5B80C","latest"]}]""",
                actual = body.text
            )
    ...
    fun `get nonce`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertTrue(body is TextContent)
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_getTransactionCount","params":["0xdE7eC4E4895D7d148906a0DFaAF7f21ac5C5B80C","pending"]}]""",
                actual = body.text
            )
    ...
    fun `batch test`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertTrue(body is TextContent)
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_getTransactionCount","params":["0xdE7eC4E4895D7d148906a0DFaAF7f21ac5C5B80C","pending"]},{"jsonrpc":"2.0","id":1,"name":"eth_getBalance","params":["0xdE7eC4E4895D7d148906a0DFaAF7f21ac5C5B80C","latest"]}]""",
                actual = body.text
            )
    ...
    fun `gas price test`() {
        val web3 = createTestWeb3 { request ->
            ...
            assertTrue(body is TextContent)
            assertEquals(
                expected = """[{"jsonrpc":"2.0","id":0,"name":"eth_gasPrice","params":[]}]""",
                actual = body.text
            )
